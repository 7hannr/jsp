			...
			<div class="card-body">
				<form name="frm">
					<div class="input-group mb-2">
						<span class="input-group-text justify-content-center">학번</span>
					...
					<div class="input-group mb-2">
						<span class="input-group-text justify-content-center">학과</span>
					...
					<div class="input-group mb-2">
						...
						<input value="${stu.birthday}" name="birthday" class="form-control" type="date">
					</div>
					<div class="text-center mt-3">
						<button class="btn btn-secondary">수정</button>
						<button class="btn btn-light">수정취소</button>
					</div>
				</form>
			</div>
		</div>
