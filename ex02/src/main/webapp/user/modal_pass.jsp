	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<input id="cpass" placeholder="새비밀번호 확인" type="password" class="form-control mb-2">
			</div>
			<div class="text-center mb-3" >
				<button type="button" class="btn btn-secondary"
					data-bs-dismiss="modal">닫기</button>
				<button id="btnSave"type="button" class="btn btn-danger">확인</button>
			</div>
		</div>
	</div>
</div>
			...
			success:function(data){
				if(data==2){
					...
					if(npass!=cpass){
						...
						if(!confrim("비밀번호를 변경하실래요?")) return;
						//비밀번호 변경
						$.ajax({
							type:"post",
