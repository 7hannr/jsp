		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="input-group mb-1">
					...
					<button id="btnSearch"class="btn btn-outline-info">검색</button>
				</div>
				<input id="address2" class="form-control mb-2" PLACEHOLDER="상세주소" value="${user.address2}">
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn btn-outline-secondary"
					data-bs-dismiss="modal">닫기</button>
				<button id="btnSave" type="button" class="btn btn-outline-danger">수정</button>
			</div>
		</div>
	</div>
</div>
