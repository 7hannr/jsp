...
<div id="page-cart">
	<h1>장바구니</h1>
	<div id="div_cart"></div>
	<div id="div_total" class="alert alert-light text-end">합계:</div>
	<div class="text-center">
		<button class="btn btn-dark px-3" id="btn-order">주문하기</button>
		<a href="/" class="btn btn-dark px-3">쇼핑 계속하기</a>
	</div>
</div>
...
<script id="temp_cart" type="x-handlebars-template">
	<div><button class="btn btn-outline-danger" id="delete">선택상품 삭제</button></div>
	<table class="table table-bordered table-hover">
		...
		<tr class="text-center" gid="{{gid}}">
			...
			<td>{{sum price qnt}}</td>
			<td><button class="btn btn-outline-danger btn-sm delete">삭제</button></td>
		</tr>
		{{/each}}
	</table>
</script>
