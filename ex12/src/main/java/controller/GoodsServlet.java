...
@WebServlet(value={"/admin/order/update","/goods/list.json","/goods/search", "/goods/search.json", 
		"/goods/insert", "/goods/list", "/goods/delete", "/goods/total","/goods/read","/admin/order/list","/admin/order/list.json"})
public class GoodsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/admin/order/list.json":// /admin/order/list.json?key=uid&word=red&page=1&size=3
