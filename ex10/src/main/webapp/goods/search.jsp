...
<div>
	...
	<div class="row mb-2">
		<div class="col">
			<button class="btn btn-outline-secondary" id="insert">선택저장</button>
		</div>
		<form name="frm" class="col-8 col-md-5">
			<div class="input-group">
				<input name="query" class="form-control" value="맥">
...
<script id="temp_shop" type="x-handlebars-template">
	<table class="table table-bordered table-hover">
		...
		<tr gid="{{productId}}" img="{{image}}" title="{{title}}" brand="{{brand}}" price="{{lprice}}">
			...
			<td>{{lprice}}</td>
			<td><button class="btn btn-secondary insert">저장</button></td>
		</tr>
		{{/each}}
	</table>
</script>
